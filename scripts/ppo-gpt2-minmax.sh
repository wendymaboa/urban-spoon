#!/usr/bin/env bash
#
# GPT-2 Minmax (Algorithm 1 + Detoxify + KL anchor) — matches ppo_minmax_experiment TRL settings.
...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/output/gpt2-minmax-500}"
...
deepspeed --num_gpus=1 \
	...
	--ptx_coeff 0.0 \
	--training_log_csv "${OUTPUT_DIR}/minmax_training_log.csv" \
