...
# ==============================================================================
#
# Launches the safe-rlhf PPO pipeline with Algorithm 1 (Value-Range Minmax
# penalty) instead of the standard KL-divergence penalty. The only difference
# from scripts/ppo.sh is:
#   - passes --use_valuerange True
#   - lowers --kl_coeff to 0.01 (KL anchor only, since Algorithm 1 is now the
#     primary safety mechanism)
#   - default output dir is output/ppo-valuerange/
#
# All other hyperparameters match scripts/ppo.sh for a clean comparison.
# ==============================================================================
...
OUTPUT_DIR="${ROOT_DIR}/output/ppo-valuerange"
unset HOSTFILE
ZERO_STAGE=3
OFFLOAD="none"
while [[ "$#" -gt 0 ]]; do
